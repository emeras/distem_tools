...
ssh root@`cat /tmp/distem_nodes_ip_* | head -1` "cd $CHARM_HOME/net-linux-x86_64/examples/charm++/load_balancing/stencil3d/ ; ./charmrun ++p $TOTAL_CORES ++nodelist $CHARM_HOME/vnodeslist ./stencil3d.prj 8192 8192 1 256 256 1"
